# I could not upload zip file so
# The two application files are going to be under the same txt file
# the two applications mnust be run in two separate pyyhon files
# THE FISRT APPLICATION STARTS HERE
